      ...
      <div className={classes.root}>
        ...
        <Grid container direction="column" spacing={4}>
          <Grid item xs={12} md={9}>
            ...
            >
              ...
              done after this. Most likely not. Ha! This model is already
              morphing into a twin fin. Which i like a lot. Full Circle is based
              on the original design that was introduced 15 years ago now. The
              original concept remains. A narrow waist, with its iconic side
              cut. The tail has the widest point way back and a deep double
              spiral vee for speed. The concept work across a wide range. I like
              the mid lengths the most."
            </Typography>
          </Grid>
        ...
        <Grid container direction="column" spacing={4}>
          ...
          <Grid item xs={12} md={8}>
            ...
            <Typography paragraph className={classes.content_font}>
              Early Slip In protoype, this board won Best In Show at The
              Boardroom Show
            </Typography>
          </Grid>
        ...
        <Grid container direction="column" spacing={4}>
          ...
          <Grid item xs={12} md={9}>
            ...
            <Typography className={classes.content_font} paragraph>
              Watch SURFERS BLOOD. The award winning surf movie by Patrick
              Trefz. Watch Thomas together with Basque surfers Kepa Acero, Natxo
              Gonzalez and Californian's Flea Vitrostko, Josh Mulcoy, Richard
              Kenvin and Shawn Barron. 2016.
            </Typography>
          </Grid>
          ...
          <Grid container direction="column">
            ...
            <Grid item xs={12} md={8}>
              ...
              >
                ...
                create a different experience by altering the form of probably
                the most recognized shape in the world. The surfboard. It became
                a journey where i explored the shape of the design icon. And
                along the way got to meet some truly inspiering individuals and
                got to travel acorss the globe. It's funny though, a very well
                regarded and distiguished surfer - that will remain unknown,
                once told me "The worst thing with surfing is surfers!" At the
                time i did nto want to beleive. However after shapinng and
                surfing for the last 20 years i now know he was right. Today i
                shape for the expereicne, I very fortunate i do not have to make
                a living shaping boards for "surfers". I am very greatful to
                have met a few of the people thhat has seen it all in the surf
                industry. And i am doing my best to learn form them. Therfeore i
                am not in the business of making surfboards, i am only making a
                few for myself and dear friends across teh globe. For me, Its
                all about the experience. When i started, the intention was to
                see if you can alter the known surfboard shape to create an
                altered experience. The feeling. In the motion. On a wave. A
                short moment where the slightest tweak can alter your total
                experience. By utalized my experience in shaping foam from
                design school with my work tool, computer modeling It was the
                same method that we designed the iMac and many other objects
                with. So it was not that difficult ot change the surfboard
                shape. Its quite simple you know. What was hard was the
                painstaking process of building and testing them. Surfing them.
                One by one. Trying ot understand. Listening. Learnign. Failing.
                Sometimes they where surfed by very good surfers. But most of
                the times by myself across the street. In mexico. Europe.
                Barbados. On foggy drizzly days. On world class days. Always
                with the aim to understand. And to find new ways of exploring
                refining and evolving. It became a long journey. Where I was
                fortunate to meet some amazing shares and surfers all over the
                world. So valuable. And a lifetime memory. I decided to
                celebrate this journey. Of this projects longevity and
                incredibly valuable journey. Research, craft and design.
                Onwards.
              </Typography>
            </Grid>
            <Grid item xs={12}>
