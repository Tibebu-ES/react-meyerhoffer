...
import { home_files, about_files } from "../../data/index";
  ...
  return (
    <div>
      ...
      <Grid container spacing={2} direction="column">
        ...
        <Grid item>
          <Typography variant="body1">4x IF Awards</Typography>
        </Grid>
        <Grid item>
          <Typography variant="body1">2x IDSA award</Typography>
        </Grid>
        <Grid item>
          <Typography variant="body1">Good Design Award (USA)</Typography>
        </Grid>
        <Grid item>
          <Typography variant="body1">SELECT PRESS</Typography>
        </Grid>
        <Grid item>
          <Typography variant="body1">The New York Times(Link)</Typography>
        </Grid>
        <Grid item>
          <Typography variant="body1">
