        ...
        <Grid container direction="column">
          ...
          <Grid item xs={12} md={8}>
            <Typography paragraph className={classes.content_font}>
              ...
              many where best sellers and a few - game changers. It started with
              the V3 for Smith, the first wrap around goggle in the market. At
              that time all goggles where looking the same.
            </Typography>
          </Grid>
          <Grid item xs={12} md={8}>
            <Typography paragraph className={classes.content_font}>
